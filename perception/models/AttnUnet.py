...
class SegmentionModel(ModelBase):
	...
	def build_model(self):
		...
		print("self.config.checkpoint=",self.config.checkpoint)
		# plot_model(model, to_file=os.path.join("C:\\Users\\kk\\Desktop\\Optic-Disc-Unet-master\\Optic-Disc-Unet-master\\experiments\\OpticDisc\\checkpoint", "model.png"), show_shapes=True)
		self.model = model